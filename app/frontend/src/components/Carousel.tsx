...
const Carousel = React.memo(({ 
  ...
  return (
    ...
    >
      ...
      {/* Fade Overlay */}
      <div className="absolute inset-0 z-10 w-full pointer-events-none bg-[linear-gradient(to_right,_#0E0E10_0%,_rgba(14,14,16,0.15)_40%,_rgba(0,0,0,0)_60%,_rgba(14,14,16,0.15)_80%,_#0E0E10_100%)]" />
    </div>
  );
}, (prevProps, nextProps) => {
